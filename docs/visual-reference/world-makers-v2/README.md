...
|---|---|---:|---|
| `logo-primary.png` | World Makers wordmark lockup, globe mark, primary public logo | 1024×1536 | `e4aed835fc09b721634a1a32b06cd6c01a5a331d468807b414a32bbdaca4a5f7` |
...
| `universe-overview.png` | Explorer + companion overlooking the World Makers universe, HUD/quest/build-category overlay | 1024×1536 | `dc9a7f162903d5fd44989d9e060ffc9143fde2b0223e097f84840962522b4f73` |
| `visual-identity-guide.png` | Brand guide sheet: color palette, shape language, design-style summary | 1312×1199 | `8082c4f66bb199e9b9b002aba80e42b4b3ab9f031292e442410c9d24ffdcdd75` |
| `forms-style-policy.png` | Shape/style policy sheet: do/don't boundary vs. voxel-block aesthetics, character style, silhouette references | 1774×887 | `acc31c94f351ad0af8204447c85ae03fd4b1f48280bfadc7d6a9c2dd4917b706` |
