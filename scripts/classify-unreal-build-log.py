...
RULES: tuple[Rule, ...] = (
    ...
    Rule(
        ...
        # UHT classification must be backed by explicit UHT/reflection evidence.
        # OtherCompilationError (5) is a generic UnrealBuildTool result and is
        # deliberately not a UHT signature.
        rx(
